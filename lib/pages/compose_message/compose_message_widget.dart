...
import 'compose_message_model.dart';
export 'compose_message_model.dart';

class ComposeMessageWidget extends StatefulWidget {
  const ComposeMessageWidget({Key? key}) : super(key: key);
...
class _ComposeMessageWidgetState extends State<ComposeMessageWidget> {
  late ComposeMessageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ComposeMessageModel());
